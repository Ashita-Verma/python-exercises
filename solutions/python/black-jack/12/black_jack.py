...
def is_blackjack(card_one, card_two):
    ...
    return {card_one, card_two} == {"A", "10"} or (
        "A" in {card_one, card_two} and (value_of_card(card_one) == 10 or value_of_card(card_two) == 10)
    )
...
def can_double_down(card_one, card_two):
    ...
    dealt_total = value_of_card(card_one) + value_of_card(card_two)
    return 8 < dealt_total < 12
